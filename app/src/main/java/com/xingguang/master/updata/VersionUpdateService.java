...
//
//    private UpdateBean versionUpdateModel;
//
...
//
//                    MyApplication.getInstance().setVersionUpdateModelCache(versionUpdateModel);
//                    if (checkVersionCallBack != null)
//                        checkVersionCallBack.onSuccess();
//                } catch (Exception e) {
//                    ToastUtils.showToast(VersionUpdateService.this, "获取版本信息失败");
//                }
//            }
//
//            @Override
...
//    }
//
//    public UpdateBean getVersionUpdateModel() {
